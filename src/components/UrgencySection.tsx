    ...
    <section className="py-20 bg-gradient-to-br from-primary to-accent text-white">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <Card className="bg-white/10 backdrop-blur border-white/20 p-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold">Instalación en 24h</h3>
            </div>
          ...
          <Card className="bg-white/10 backdrop-blur border-white/20 p-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold">Garantía total</h3>
            </div>
            <p className="text-lg opacity-90">
        ...
        <div className="text-center">
          <Button 
            size="lg" 
            className="bg-white text-primary hover:bg-yellow-50 text-xl px-12 py-6 shadow-2xl animate-pulse-glow transform hover:scale-105 transition-all duration-300"
            asChild
          >
